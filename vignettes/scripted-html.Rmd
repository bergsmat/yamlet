...
Work<sub>total<sub>obs</sub></sub>. The label for column ```time``` suggests
Time<sub>cum</sub><sup>&#945;</sup>.  The dot closes the subscript to distinguish
this from Time<sub>cum<sup>&#945;</sup></sub>.


How does this look when we plot it?
```{r, fig.width = 3.73, fig.height = 2.52}
x %>% 
  resolve %>% 
