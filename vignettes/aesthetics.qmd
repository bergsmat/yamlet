...
the plot is rendered with decorations (left) and without (right).

 * Notice that the y axis label is 'y' not 'z' (as in summary), consistent
   with default ggplot behavior where no label is supplied.
 * Notice that the label for color and shape 'Groups', not 'Subset', 
